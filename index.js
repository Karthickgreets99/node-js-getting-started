...
express()
  ...
  .get("/sandbox", (req, res) => res.render("pages/index"))
  .get("/development", (req, res) => res.render("pages/index"))
  ...
  .get("/airbnb/login", (req, res) => res.render("pages/login"))
  .get("/airbnb/emplogin", (req, res) => res.render("pages/Employee_portal"))
  .get("/airbnb/Account_Airbnb", (req, res) =>
    res.render("pages/Account_Airbnb")
  )
  .use("/callback", async (req, res) => {
    ...
    if (idToken) {
      ...
      const authTokens = await appleSignin
        .getAuthorizationToken(code, {
          ...
          clientSecret:
            "eyJraWQiOiI1QjI1SzU1RjRTIiwiYWxnIjoiRVMyNTYifQ.eyJpc3MiOiJMMkRIVExBUDdLIiwiaWF0IjoxNTYwNjU2OTQ2LCJleHAiOjE1NzYyMDg5NDYsImF1ZCI6Imh0dHBzOi8vYXBwbGVpZC5hcHBsZS5jb20iLCJzdWIiOiJjb20ucGF5cGFsLmxvZ2luLmNsaWVudCJ9.zyD0SRHFokYpc0ctS6igjAIx76xJYfXS_IVNYS73GrtaSZ3PtLjBx8WbYZfsN_DsXXPWOCzAKF2J1EsU8VaiVg"
        })
        .then(async tokenResponse => {
          // console.log(tokenResponse);
          // const idTokenData = jwtDecode.decode(tokenResponse.id_token);
          const idTokenData = await appleSignin.verifyIdToken(
            tokenResponse.id_token,
            "com.paypal.login.client"
          );
